...
public final class ValidateIDCardTextCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ValidateIDCardTextCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ValidateIDCardText command = new ValidateIDCardText();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action(parameters.get("text") != null ? (String)parameters.get("text").get() : (String)null ));
