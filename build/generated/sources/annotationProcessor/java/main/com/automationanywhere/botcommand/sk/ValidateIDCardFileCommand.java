...
public final class ValidateIDCardFileCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ValidateIDCardFileCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ValidateIDCardFile command = new ValidateIDCardFile();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action(parameters.get("textfile") != null ? (String)parameters.get("textfile").get() : (String)null ));
